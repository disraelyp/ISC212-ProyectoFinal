...
public class ListadoVendedores extends JDialog {
	...
	public ListadoVendedores(boolean seleccion) {
		setModal(true);
		setResizable(false);
		...
		contentPanel.setLayout(null);
		{
			...
			btnNewButton.setBounds(10, 462, 324, 23);
		...
		JButton btnVer = new JButton("Ver Vendedor");
		...
		btnSeleccionar.setBounds(10, 428, 324, 23);
